...
router.get('/yutub/video', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false,  message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/dl/ytmp4?url=${url}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ig/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false,  message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/dl/igstalk?nama=${username}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/virtualslot', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.xteam.xyz/game/virtualslot?APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/suit', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false,  message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/game/suit?q=${text}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
if (!carik) return res.json({ status : false,  message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/search/grupwa?q=${carik}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/latin/kejawa', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false,  message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/aksara/jawakelatin?text=${text}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/samehadaku', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.xteam.xyz/anime/samehadaku?q=${search}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/waifu', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.xteam.xyz/anime/waifu?APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hokynomor', async (req, res, next) => {
	...
	if (!text) return res.json({ status : false,  message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://docs-jojo.herokuapp.com/api/nomer_hoki?nomer=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
