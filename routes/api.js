...
router.get('/heroml', async (req, res, next) => {
	...
	if (!name) return res.json({ status : false,  message : "masukan parameter name"})
       ...
       fetch(encodeURI(`https://api.xteam.xyz/search/heroml?q=${name}&APIKEY=b503570de94469fc`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/angka', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            nomor = req.query.nomor
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
	if (!nomor) return res.json({ status : false,  message : "masukan parameter name"})
	

       fetch(encodeURI(`https://api.xteam.xyz/game/tebakangka?q=${nomor}&APIKEY=AbilGanss`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/amongus', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.xteam.xyz/game/amongus?APIKEY=AbilGanss`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/tagihan/Indihome', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            nomor = req.query.nomor
	...
	if (!nomor) return res.json({ status : false,  message : "masukan parameter name"})
       ...
       fetch(encodeURI(`http://hujanapi.herokuapp.com/api/tagihanindihome?nomor=${nomor}&apikey=trial2k21`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/tagihan/pln', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            nomor = req.query.nomor
	...
	if (!nomor) return res.json({ status : false,  message : "masukan parameter name"})
       ...
       fetch(encodeURI(`https://hujanapi.herokuapp.com/api/plnpascabayar?query=${nomor}&apikey=trial2k21`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/bitcoin', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.coindesk.com/v1/bpi/currentprice/btc.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covid19', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://dekontaminasi.com/api/id/covid19/hospitals`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/sekolah', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://datasekolahapi.herokuapp.com/api/data`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/merdeka', async (req, res, next) => {
	...
	if(apikeyInput != 'alpin1') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://pencarikode.xyz/news/merdeka?apikey=Tester`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/amazon', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false,  message : "masukan parameter text"})
       ...
       fetch(encodeURI(`https://leyscoders-api.herokuapp.com/api/amazon-search?q=${text}&apikey=dappakntlll`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
